...
import com.aldoSanchez.destinatarios.model.DestinatarioWithEnvios;
import com.aldoSanchez.destinatarios.model.Envio;
import com.aldoSanchez.destinatarios.repository.EnvioClient;
...
public class DestinatarioController {
    ...
    @GetMapping("/{id}")
    public DestinatarioWithEnvios getDestinatarioWithEnvios(@PathVariable Long id) {
        Destinatario destinatario = destiServ.findDestinatario(id);
        List<Envio> envios = envioClient.getEnviosByDestinatarioId(id);
        return new DestinatarioWithEnvios(destinatario, envios);
    }
